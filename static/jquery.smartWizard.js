...
;(function ($, window, document, undefined) {
    ...
    var defaults = {
        ...
        autoAdjustHeight: true, // Automatically adjust content_backend height
        ...
        contentURL: null, // content_backend url, Enables Ajax content_backend loading. Can also set as data data-content_backend-url on anchor
        contentCache: true, // cache step contents, if false content_backend is fetched always from ajax url
    ...
    $.extend(SmartWizard.prototype, {
        ...
        _setElements: function () {
            ...
            // Set content_backend container
            this.container.addClass('sw-container tab-content_backend');
            // Set content_backend pages
            this.pages.addClass('tab-pane step-content_backend');
        ...
        _setToolbar: function () {
            ...
            var btnNext = this.options.toolbarSettings.showNextButton !== false ? '' : null;
            var btnPrevious = this.options.toolbarSettings.showPreviousButton !== false ? '' : null;
            var btnGroup = '$';
            ...
            switch (this.options.toolbarSettings.toolbarPosition) {
                case 'top':
                    toolbarTop = $('<div></div>').addClass('btn-toolbar sw-toolbar sw-toolbar-top justify-content_backend-' + this.options.toolbarSettings.toolbarButtonPosition);
                    ...
                    break;
                case 'bottom':
                    toolbarBottom = $('<div></div>').addClass('btn-toolbar sw-toolbar sw-toolbar-bottom justify-content_backend-' + this.options.toolbarSettings.toolbarButtonPosition);
        ...
        _loadStepContent: function (idx) {
            ...
            var contentURL = elm.data('content_backend-url') && elm.data('content_backend-url').length > 0 ? elm.data('content_backend-url') : this.options.contentURL;
            ...
            if (contentURL && contentURL.length > 0 && (!elm.data('has-content_backend') || !this.options.contentCache)) {
                // Get ajax content_backend and then show step
                ...
                var ajaxSettings = $.extend(true, {}, {
                    ...
                    success: function (res) {
                        if (res && res.length > 0) {
                            elm.data('has-content_backend', true);
                            selPage.html(res);
                        }
                        mi._loader('hide');
                        mi._transitPage(idx);
        ...
        _transitPage: function (idx) {
            ...
            // Fix height with content_backend
            this._fixHeight(idx);
        ...
        reset: function () {
            ...
            this.steps.data('has-content_backend', false);
            this.init();
