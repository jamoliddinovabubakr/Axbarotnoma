...
class Article(models.Model):
    ...
    editor = models.ForeignKey('user_app.User', verbose_name='Taxrirchi', on_delete=models.CASCADE, blank=True, null=True,
                               related_name="article_editor")
    analyst = models.ForeignKey('user_app.User', verbose_name='Tahlilchi', on_delete=models.CASCADE, blank=True, null=True,
    ...
    state_analysis = models.ForeignKey('user_app.State', on_delete=models.CASCADE, related_name="article_state_analysis")
